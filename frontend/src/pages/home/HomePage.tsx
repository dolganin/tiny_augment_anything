  ...
  return (
    <>
      <PageFrame
        ...
        description="Здесь хранится каталог твоих датасетов, их текущий этап обработки и история последних операций. Загрузи новый архив или вернись к уже начатому пайплайну."
